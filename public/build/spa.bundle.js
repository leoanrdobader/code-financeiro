...
/***/ function(module, exports, __webpack_require__) {
	...
	var _localStorage = __webpack_require__(74);
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _jwt = __webpack_require__(79);
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    data: function data() {
	        return {
	            menus: [{ name: 'Conta Bancaria', routeName: 'bank-account.list' }, { name: 'Contas a Pagar', dropdownId: 'teste' }, { name: 'Contas a Receber', routeName: 'auth.login' }],
	            menusDropdown: [{
	                id: 'teste',
...
/***/ function(module, exports, __webpack_require__) {
	...
	var _BankAccountList = __webpack_require__(101);
	        ...
	        login: function login() {
	            ...
	            _auth2.default.login(this.user.email, this.user.password).then(function () {
	                ...
	                switch (responseError.status) {
	                    case 401:
	                        _this.error.message = responseError.data;
	                        break;
	                    default:
...
/***/ function(module, exports, __webpack_require__) {
	...
	if (false) {(function () {  module.hot.accept()
	  ...
	  hotAPI.install(require("vue"), false)
	  if (!hotAPI.compatible) return
	  var id = "_v-192e9466/BankAccountList.vue"
	  if (!module.hot.data) {
	    hotAPI.createRecord(id, module.exports)
	  } else {
	    hotAPI.update(id, module.exports, __vue_template__)
...
/***/ function(module, exports, __webpack_require__) {
	...
	exports.default = {
	    ...
	    created: function created() {
	        ...
	        _resources.BankAccount.query().then(function (response) {
	            _this.bankAccounts = response.data.data;
	        });
	    },
	    ...
	    methods: {
	        destroy: function destroy() {
	            ...
	            _resources.BankAccount.delete({ id: this.bankAccountToDelete.id }).then(function (response) {
	                _this2.bankAccounts.$remove(_this2.bankAccountToDelete);
	                _this2.bankAccountToDelete = null;
